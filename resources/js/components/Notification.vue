                    ...
                    <div class="d-flex border-bottom align-items-start">
                      ...
                      <div class="flex-grow-1">
                        ...
                        <div class="text-muted">
                          <p class="mb-1 font-size-13">Your task changed an issue from "In Progress" to <span
                              class="badgebg-success-subtle text-success">Review</span></p>
                          <p class="mb-0 font-size-10 text-uppercase fw-bold"><i class="mdi mdi-clock-outline"></i> 1
                            hours ago</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="d-flex border-bottom align-items-start">
                      ...
                      <div class="flex-grow-1">
                        ...
                        <div class="text-muted">
                          ...
                          <p class="mb-0 font-size-10 text-uppercase fw-bold"><i class="mdi mdi-clock-outline"></i> 5
                            hours ago</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="d-flex border-bottom align-items-start">
                      ...
                      <div class="flex-grow-1">
                        ...
                        <div class="text-muted">
                          ...
                          <p class="mb-0 font-size-10 text-uppercase fw-bold"><i class="mdi mdi-clock-outline"></i> 3
                            days ago</p>
                        </div>
                      </div>
                    </div>
